...
public class TesteAnimal {
	...
	public static void main(String[] args) {
		...
		String somcao, somcavalo, sompreguica;
		...
		//emitindo sons
		System.out.println("Qual som o cachorro deve emitir? ");
		somcao = ler.nextLine();
		c1.emitirSom(somcao);
		System.out.println("Qual o som que o cavalo deve emitir? ");
		somcavalo = ler.nextLine();
		cv1.emitirSom(somcavalo);
		System.out.println("Qual o som que a preguica deve emitir? ");
		sompreguica = ler.nextLine();
		p1.emitirSom(sompreguica);
	}
}